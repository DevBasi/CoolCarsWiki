...
* **Зависимости:** Установленный [ProtocolLib](https://www.spigotmc.org/resources/protocollib.1997/) (обязательно).
...
* **Обработка поверхностей:** Передвижение по полублокам (Slabs), ступеням и склонам.
...
<div align="center">
  <sub>Разработано <b>BasiDev</b> для современных Minecraft серверов.</sub>
</div>
