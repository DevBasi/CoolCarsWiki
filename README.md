...
2. Поместите файл `CoolCars-1.0.0.jar` в папку `/plugins/`.
...
Если вы обнаружили баг или техническую проблему, пожалуйста, напишите в личные сообщения Discord: **devbasi**
